...
if (isset($_GET['zi']) AND isset($_GET['luna']) AND isset($_GET['an'])) {
    $zi = str_replace($invalid_characters, "", $_GET['zi']);
    $ziAnterioara = $zi - 1;
                ...
                <div>
                    ...
                    <table class="table-bordered table-striped table-condensed cf col-md-12 tabel-raport">
                        ...
                        $queryAparate = "SELECT "
                                ...
                                . " FROM "
                                . $_SESSION['database'] . ".aparate "
                                . "INNER JOIN "
                                . $_SESSION['database'] . ".contormecanic" . $an . $luna
                                . " ON "
                        ...
                        if ($resultAparate = $con->query($queryAparate)) {
                            ...
                            for ($i = 0; $i < sizeof($informatii); $i+=2) {
                                $queryVariabile = "SELECT variabile.fm_mec, pi_mec, MAX(variabile.data) FROM " . $_SESSION['database'] . ".variabile WHERE variabile.data <= '" . $an . "-" . $luna . "-" . $zi . "'";
