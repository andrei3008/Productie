                    ...
                    <table class="table-bordered table-striped table-condensed cf col-md-12 tabel-raport">
                        ...
                        if ($resultAparate = $con->query($queryAparate)) {
                            ...
                            for ($i = 0; $i < sizeof($informatii); $i+=2) {
                                $queryVariabile = "SELECT variabile.fm_mec, pi_mec, MAX(variabile.data) FROM brunersrl.variabile WHERE variabile.data <= '" . $an . "-" . $luna . "-" . $zi . "' AND variabile.idAparat='".$informatii[$i]->idAparat."'";
