...
$query = "SELECT "
        ...
        . "INNER JOIN "
        . "" . $_SESSION['database'] . ".firme O"
        . "N locatii.idfirma=firme.idfirma "
        . "INNER JOIN " . $_SESSION['database'] . ".personal ON locatii.idresp = personal.idpers"
                ...
                <div>
                    ...
                    <table class="table-bordered table-striped table-condensed cf col-md-12 tabel-raport">
                        ...
                        $queryMax = "SELECT"
                                ...
                                . " contor.idxOutM,"
                                . " contor.dtServer"
                                . " FROM ampera.contormecanic" . $an . $luna . " as contor"
                                . " INNER JOIN ampera.aparate "
                                . " ON contor.idAparat = aparate.idAparat"
                                . " WHERE NOT EXISTS (SELECT * FROM ampera.contormecanic201512 as contor2"
                                . " WHERE contor2.idAparat = contor.idAparat"
                                . " AND contor2.idxInM > contor.idxInM) "
                                . " AND contor.idLocatie=" . $idLocatie . ' ORDER by contor.idAparat ASC';
                        $queryMin = "SELECT"
                                . " aparate.idAparat,"
                                . " aparate.seria,"
                                . " aparate.idxInM as inInitial,"
