            ...
            <div id="Tbl_02">
                <table style='position: relative'>
                    ...
                    <tr>
                        ...
                        <td><label><input <?php if (isset($numeCamp['bit26'])) {
                                    echo "class='checkbox'";
                                } ?> class="left" type="checkbox" name="bit26" <?php if (isset($numeCamp['bit26'])) {
                                    echo "checked";
                                } ?>/>Cind se
                                Modifica</label></td>
                        <td></td>
...
<div id="stareAparatBazaDeDate" class="left" style="display: inline-block; float : right;">
    ...
    <div id="tabel">
        <form name="CfgAparat" method="POST" id="configForm" style="display: inline-block; float:left">
            <div id="content_cfg" class="formAudit" style='width: 600px;'>
